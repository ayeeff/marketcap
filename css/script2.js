...
// Train Empire Info (moved to global scope)
const hsrEmpireInfo = {
    1: { name: 'Steam & Colonies', color: '#3b82f6', symbol: '🚂' },
    2: { name: 'Oil & Silicon', color: '#ef4444', symbol: '🛢️' },
    3: { name: 'Rare Earths, Renewables & Robotics', color: '#10b981', symbol: '🤖' }
};
...
// Minimal country name -> ISO2 lookup for common countries
